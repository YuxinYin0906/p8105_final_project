...
```{r Destination unique valus}

df_2013 |> group_by(dest) |> summarise(prop = round(n()*100/dim(df_2013)[1],2)) |> arrange(desc(prop))
df_2017 |> group_by(dest) |> summarise(prop = round(n()*100/dim(df_2017)[1],2)) |> arrange(desc(prop))
```
...
```{r carrier unique valus}

df_2013 |> group_by(carrier) |> summarise(prop = round(n()*100/dim(df_2013)[1],2)) |> arrange(desc(prop))
df_2017 |> group_by(carrier) |> summarise(prop = round(n()*100/dim(df_2017)[1],2)) |> arrange(desc(prop))
```
...
```{r Tailnum unique valus}

df_2013 |> group_by(tailnum) |> summarise(prop = round(n()*100/dim(df_2013)[1],2)) |> arrange(desc(prop))
df_2017 |> group_by(tailnum) |> summarise(prop = round(n()*100/dim(df_2017)[1],2)) |> arrange(desc(prop))
```
