...
![Finding the Best Hyperparameter](image/best_hyperparameter.png){width=45%}
...
![Comparison between Two Models](image/rf.png){width=45%}

By looking at the graph, we could clearly find that the random forest model performs better that logistic regression model.
